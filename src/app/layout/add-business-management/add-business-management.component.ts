...
@Component({
  selector: 'app-add-business-management',
  templateUrl: './add-business-management.component.html',
  styleUrls: ['./add-business-management.component.css']
})
export class AddBusinessManagementComponent implements OnInit {
  ...
  cleanForm(){
    ...
    this.latitude='';
    this.longitude='';
    this.sun=this.mon=this.tue=this.wed=this.thr=this.fri=false;
    this.rating='';
  }
  addEv(){
    ...
    if(this.validateForm()){
      ...
      this.mgmt.addBussiness(dataToSend).subscribe(response=>{
  ...
  onSubmit(){
    ...
    let data = {
      businessId: this.addBusinessForm.value.businessId,
      name: this.addBusinessForm.value.name,
      email: this.addBusinessForm.value.email,
      phone: this.addBusinessForm.value.phone,
      category: this.addBusinessForm.value.category,
      subcategory: this.addBusinessForm.value.subcategory,
      timeFrom: this.addBusinessForm.value.timeFrom,
      timeTo: this.addBusinessForm.value.timeTo,
      description: this.addBusinessForm.value.description,
    }
