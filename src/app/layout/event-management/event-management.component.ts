...
const ELEMENT_DATA: PeriodicElement[] = [
  {eventid: 'BHGV5451', name: 'Hydrogen', contact: 9988776655, email: 'xyz@gmial.com', location: 'India', status: 'active'},
  {eventid: 'BHGV5451', name: 'Adrogen', contact: 9988776655, email: 'xyz@gmial.com', location: 'India', status: 'inactive'},
];
...
export class EventManagementComponent implements OnInit {
  ...
  displayedColumns: string[] = ['eventid', 'name', 'contact', 'email', 'location', 'st-date', 'end-date', 'action'];
  ...
  ngOnInit() {
    ...
    this.mgmt.listEvent().subscribe(response=>{
      this.eventlist = response['data']
      this.dataSource = new MatTableDataSource<PeriodicElement>(this.eventlist);
  ...
  // }
  blockEv(){
    this.mgmt.blockEvent(this.tempid).subscribe(response=>{
  ...
  unblockEv(){
    this.mgmt.unblockEvent(this.tempid).subscribe(response=>{
